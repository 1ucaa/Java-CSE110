    ...
    public static void main(String[] args){
        ...
        if (heiPro > 0){
            if (ele > heiPro) {
                ...
                System.out.println("CONGRATS! You have hit the target.");
                if (heiPro > (ele+(hei/3)) && heiPro < (ele+(2*hei/3))){
                    System.out.print("Not only did you hit the target. IT WAS A BULLSEYE!");
                }
            }
        }
        if (heiPro < 0) {
